...
Config = {
  ...
  Langs = {
    ...
    TitleOnDead        = "Vous avez perdu connaissance",
    ...
    prompt             = "Réaparition", -- prompt group label
    ...
    cantCarry          = "VORP : Impossible de transporter plus d'armes !",
    Hold               = "MyServerName",
    Load               = "Chargement en cour",
    Almost             = "Bienvenue sur MyServerName",
    Holddead           = "Vous avez perdu connaissance",
    Loaddead           = "Vous avez quitté le serveur en étant dans le coma.",
    forcedrespawn      = "Vous pourez réapparaître",
    forced             = "Parce que vous avez quitté le serveur en étant mort. ",
    sit                = "Vous devez vous assoir.",
    NotifyChar         = "La taille de votre joueur dois être comprise entre 0.90 et 1.1",
    NotifyCharSelect   = "Une fois que vous ~e~supprimez ~q~un caractère, vous ne pouvez plus revenir en arrière !",
    PVPNotifyOn        = "PVP On ",
    PVPNotifyOff       = "PVP Off",
    AddChar            = "Added Multicharacter ",
    RemoveChar         = "Removed Multicharacter ",
    WrongHex           = "Votre SteamHex n'est pas dans la base de donnée",
